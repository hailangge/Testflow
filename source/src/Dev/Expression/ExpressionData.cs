...
namespace Testflow.Utility.Expression
{
    ...
    public class ExpressionData : IExpressionData
    {
        ...
        public IExpressionElement Source
        {
            ...
            {
                this._source = value;
                if (null != Parent && null != this._source)
                {
        ...
        public IList<IExpressionElement> Arguments
        {
            ...
            set
            {
                ...
                if (null != Parent && null == this._source && null != value)
                {
                    foreach (IExpressionElement element in this._arguments)
                    {
...
//            this.Source = new ExpressionElement();
        ...
        public void Initialize(ISequenceFlowContainer parent)
        {
            ...
            if (null != parent)
            {
                ...
                foreach (IExpressionElement argument in this._arguments)
                {
